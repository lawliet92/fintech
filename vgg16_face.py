...
# load data
my_data = loadtxt('/Volumes/JasonWork/Data/fer2013/fer2013.csv', delimiter=",")
...
label = loadtxt('/Volumes/JasonWork/Data/fer2013/labels.csv', delimiter=",")
...
filepath='/Volumes/JasonWork/Data/fer2013/TF_Vgg16_FC_weights-improvement-{epoch:02d}-{val_acc:.2f}.hdf5'
...
img=mpimg.imread('/Users/Jason/Downloads/JackyChan3-1.jpg')
